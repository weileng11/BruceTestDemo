...
import com.bruce.core.callback.IDialog;
import com.bruce.core.utils.StringUtil;
import com.bruce.core.view.UnifyTextView;
...
public class UnifyDialog implements IDialog {
    ...
    public UnifyDialog(BaseActivity activity, String title, String content, String leftBtnTxt, String rightBtnTxt) {
        ...
        if (StringUtil.isNull(leftBtnTxt)) {
            mHasLeftBtn = false;
        }
